...
<html>
	...
	<body>
		<a href="#edit-docCategory" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-docCategory" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${docCategoryInstance?.version}" />
				<fieldset class="form">
